...
export default class TVController {
    ...
    static async validateSmartCard(req: Request, res: Response) {
        try {
            ...
            logger.error('Error validating smart card', error);
            ...
            return res.status(500).json({
                status: 'error',
                message: 'An error occurred while validating the smart card',
            });
        }
    }
    ...
    static async getTVPackages(req: Request, res: Response) {
        try {
            ...
            logger.error('Error getting TV packages', error);
            ...
            return res.status(500).json({
                status: 'error',
                message: 'An error occurred while retrieving TV packages',
            });
        }
    }
    ...
    static async purchaseTV(req: AuthenticatedRequest, res: Response) {
        try {
            ...
            logger.error('Error purchasing TV subscription', error);
            ...
            return res.status(500).json({
                status: 'error',
                message: 'An error occurred while processing your TV subscription purchase',
            });
        }
    }
    ...
    static async getSupportedProviders(req: Request, res: Response) {
        try {
            ...
            logger.error('Error getting supported TV providers', error);

            return res.status(500).json({
                status: 'error',
                message: 'An error occurred while retrieving supported TV providers',
            });
        }
    }
