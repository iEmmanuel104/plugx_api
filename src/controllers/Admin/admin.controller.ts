...
//         const stats = await AdminService.getInstructorStats();
//         res.status(200).json({
//             status: 'success',
...
//         const topCourses = await AdminService.getTopCourses(Number(limit));
//         res.status(200).json({
//             status: 'success',
...
//     static async getRevenueStats(req: AdminAuthenticatedRequest, res: Response) {
//         const { timeFrame, courseId } = req.query;
//         const stats = await AdminService.getRevenueStats(timeFrame as string, courseId as string);
//         res.status(200).json({
//             status: 'success',
