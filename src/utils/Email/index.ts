...
export default class EmailService {
        ...
        return async (options) => {
            ...
            try {
                ...
                await Promise.all((options.postmarkInfo ?? []).map(async (recipient) => {
                    const mailOptions = {
                        from: `PlugX Accounts<${EMAIL_HOST_ADDRESS}>`,
    ...
    //     case 'support':
    //         return 'support@PlugX.com';
    //     case 'vibes':
    //         return 'vibes@PlugX.com';
    //     default:
    //         return 'accounts@PlugX.com';
    //     }
    // }
    ...
    //                     ...(senderEmail === 'vibes@PlugX.com' ? { MessageStream: 'vibes' } : {}),
    //                 };
    //                 return message;
    //             });
    //         } else {
